...
public class EntityGenerator extends AbstractGenerator {
    ...
    public void generate() {
        ...
        Properties dbProps = loadProperties("db-config.properties");
        ...
        Path dirPath = Paths.get(entityConfig.getProperty("output.dir"),
                entityConfig.getProperty("package.name").replaceAll("\\.", "/"));
        try {
